import { calculate, supportedAirlines } from "@/app/_shared/calculators/qantas/calculator";
import { qantasSegmentInputAdapter } from "@/app/_shared/calculators/qantas/fareClassInput";
import {
  PARTNER_NON_ONEWORLD_AIRLINES,
  PARTNER_ONEWORLD_AIRLINES,
  QANTAS_GRP_AIRLINES,
} from "@/app/_shared/models/qantasConstants";
import { buildAirlineOptions, type AirlineOption } from "@/app/_shared/components/segmentInput";
