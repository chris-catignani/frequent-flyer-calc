import { fetchDataFromQantas } from "@/calculators/qantas/qantasAPIClient";
import { getPartnerRules } from "@/calculators/qantas/rules/partnerRules";
import { getQantasEarnCategory } from "@/calculators/qantas/earnCategories/qantasEarnCategories";
import { getQantasMinimumPoints, getQantasRules } from "@/calculators/qantas/rules/qantasRules";
import {
  getPartnerEarnCategory,
  qualifiesForElitePoints,
} from "@/calculators/qantas/earnCategories/partnerEarnCategories";
import { LATAM_AIRLINES, ONEWORLD_AIRLINES } from "@/constants/airlines";
